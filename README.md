...
ImageButton.Image = "https://i.imgur.com/P8tIRil.png"
...
spawn(function()
	while wait() do
		if NgayXuaNgayXuaCoNguoiTenLaNightMareRobloxTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangkyDi then
			pcall(function()
				local args = {
